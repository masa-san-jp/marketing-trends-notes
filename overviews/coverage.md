...
trend **12** 件（stub 0件は不算入）／内訳 {'draft': 3, 'stub': 0, 'verified': 9}
...
- practice_linked: 10/11 の practice が responds_to を持つ（下限比率 0.5）
- resolved_predictions: 0/5 件の予測が答え合わせ済み

関係を持たない trend: trend/school-generative-ai-governance
...
**応答なきトレンド**
- 学校教育における生成AI利用の制度化 に応答する practice が無い。打ち手に落ちていない（判断材料として未完成）
<!-- generated:audit:end -->
