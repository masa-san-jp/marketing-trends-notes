...
trend **11** 件（stub 0件は不算入）／内訳 {'draft': 3, 'stub': 0, 'verified': 8}
...
- practice_linked: 9/10 の practice が responds_to を持つ（下限比率 0.5）
- resolved_predictions: 0/5 件の予測が答え合わせ済み

関係を持たない trend: trend/functional-food-safety-governance
...
**応答なきトレンド**
- 機能性表示食品の安全・表示管理強化 に応答する practice が無い。打ち手に落ちていない（判断材料として未完成）
<!-- generated:audit:end -->
