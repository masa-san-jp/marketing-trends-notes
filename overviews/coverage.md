...
データの最新日: 2026-09-17 — `python3 tools/build_graph.py` が生成（手で書き換えない）
...
- forward_stated_ratio: 0.40（下限 0.0・第一節とpredictionsを持つtrend）
- intended_evidence_ratio: 0.37（下限 0.0・tense: intendedの根拠を持つtrend）
