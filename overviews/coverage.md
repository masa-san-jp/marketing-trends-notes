...
trend **5** 件（stub 0件は不算入）／内訳 {'draft': 3, 'stub': 0, 'verified': 2}

| カテゴリ | 2018 | 2020 | 2021 | 2022 | 2023 | 年代不明 | 計 |
|---|---|---|---|---|---|---|---|
...
- practice_linked: 3/4 の practice が responds_to を持つ（下限比率 0.5）
- resolved_predictions: 0/5 件の予測が答え合わせ済み

関係を持たない trend: trend/creator-ad-disclosure
...
**応答なきトレンド**
- クリエイター広告表示の可視化 に応答する practice が無い。打ち手に落ちていない（判断材料として未完成）
<!-- generated:audit:end -->
