...
trend **8** 件（stub 0件は不算入）／内訳 {'draft': 3, 'stub': 0, 'verified': 5}
...
関係を持たない trend: trend/plastic-resource-circulation
...
**応答なきトレンド**
- プラスチック資源循環対応の制度化 に応答する practice が無い。打ち手に落ちていない（判断材料として未完成）
<!-- generated:audit:end -->
