...
trend **2** 件（stub 0件は不算入）／内訳 {'draft': 2, 'stub': 0, 'verified': 0}

| カテゴリ | 2018 | 2020 | 年代不明 | 計 |
|---|---|---|---|---|
| consumer-goods（消費財・日用品） |  |  |  | 0 |
| retail-commerce（小売・EC） |  |  |  | 0 |
| entertainment-content（エンタメ・コンテンツ） |  | 1 |  | 1 |
| creator-economy（クリエイターエコノミー） |  |  |  | 0 |
| saas-b2b（SaaS・B2B） |  |  |  | 0 |
...
**応答なきトレンド**
- ショート動画視聴の主流化 に応答する practice が無い。打ち手に落ちていない（判断材料として未完成）
<!-- generated:audit:end -->
