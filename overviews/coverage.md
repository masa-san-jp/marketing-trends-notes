...
- practice_linked: 5/6 の practice が responds_to を持つ（下限比率 0.5）
- resolved_predictions: 0/5 件の予測が答え合わせ済み

関係を持たない trend: trend/sustainable-fashion-behavior
...
**応答なきトレンド**
- サステナブルファッションへの関心・循環行動 に応答する practice が無い。打ち手に落ちていない（判断材料として未完成）
<!-- generated:audit:end -->
