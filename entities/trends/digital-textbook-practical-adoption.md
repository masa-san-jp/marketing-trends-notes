---
id: trend/digital-textbook-practical-adoption
uri: urn:mtn:trend/digital-textbook-practical-adoption
type: trend
kind: demand-shift
stage: growing
market: education
geo: japan
label_ja: デジタル教科書の実用化
label_en: Practical adoption of digital textbooks
authority:
  wikidata: null
  none_reason: "「デジタル教科書の実用化」「practical adoption of digital textbooks Japan」で検索したが、日本の学校現場での導入・活用変化そのもののWikidata項目は確認できない（2026-08-11検索実施）"
time:
  start: "2019~"
  end: ".."
  display: "2019年の段階導入から、2024年度以降に英語等を全小中学校へ提供する実用化局面"
naming:
  self_identified: false
  named_by: null
  named_when: null
  original_label: 学習者用デジタル教科書の段階導入・活用拡大
  note: "「デジタル教科書の実用化」は、文部科学省の導入方針と活用調査を要約するための記述的なラベル"
freshness:
...
**kind: demand-shift とした。** 観測しているのは教師・学校が授業でデジタル教科書を使う頻度という教育現場の行動変化であり、特定ベンダーの販売額ではない。

**stage: growing とした。** 全国対象の提供範囲が広がり、2024年度の使用頻度も前年度より上がった。一方、教科・学年・学校環境による差があり、全面的な標準化とは判定しない。

## 時間

2019年4月の段階導入を含む `2019~` とした。終点は `..`（継続中）。
...
- 次回以降の同じ調査で使用頻度が低下し、全国対象の提供拡大が授業実践に波及していないと分かる
- 教科・学年・地域を分けると、導入・活用が一部の実証校に限られ、学校全体の実用化が確認できない
- デジタル教科書の使用頻度が上がっても、学習上の理解や配慮の改善が再現されない
