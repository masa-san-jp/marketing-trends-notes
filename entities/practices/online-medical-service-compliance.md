...
**効果未確認**: オンライン完結率、対面切替率、再診率、患者負担、通信障害、ヒヤリハットを同じ定義で追っていない。対象外の症例を無理にオンライン化すると、利便性より安全管理上の負担が大きくなる。
...
**効果未確認**: 医療機関または関連サービスの一つの診療フローで、適用判定、本人確認、記録、対面切替、問い合わせ、インシデントを月次で点検する。医療行為や法令適合の判断は有資格者と担当官庁の最新情報に従う。
