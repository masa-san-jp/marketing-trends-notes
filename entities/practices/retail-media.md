...
小売事業者（EC・ドラッグストア・コンビニ等）が、対象事業者の購買データと売場（サイト内検索・アプリ・
...
**効果未確認**:（対象事業で試していない）。効いた・効かないを書ける段階にない。
...
**効果未確認**: 小規模事業者にとっては「買う側」より「対象事業者の顧客接点を広告面として設計する側」の
発想（対象事業者サイト・メルマガ・同梱物の面としての価値づけ）に転用できる可能性があるが、これは
