...
配信する**。自社アカウントの投稿だけでなく、クリエイターの投稿を本人の許諾コードを介して広告に使える。
...
- オーガニック投稿を使った広告配信で、**ブースト中に得た再生・コメント・シェア・いいね・フォローは
  元のオーガニック投稿に帰属する**
- 自社アカウントの投稿と、**他のクリエイターの投稿（本人の許諾つき）**の両方を使える
...
**未実施**（自分では試していない）。効いた・効かないを書ける段階にない。
...
**未実施。** 手元にあるのは note と X の投稿で、これらに同型の仕組み（既存投稿をそのまま配信し、
