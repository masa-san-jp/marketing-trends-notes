...
**未実施。** プラットフォーム別の流入、記事到達、購読、広告単価、契約対価、編集・配信コストを同じ定義で追っていない。アルゴリズム変更やニュース価値の差が大きい場合、単純な順位・PV最適化は品質や信頼を損なう。
...
**未実施。** 一つの媒体で流入元、送客、購読、広告、対価、表示順位、記事品質の指標を分け、アルゴリズム変更前後を比較できるログを整える。
