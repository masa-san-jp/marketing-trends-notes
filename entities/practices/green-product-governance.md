...
**効果未確認**:（対象事業で日用品・雑貨の環境負荷情報、認証表示、回収を運用していない）。商品別の表示理解、購入・継続利用、修理・詰め替え・
回収の利用率、問い合わせ・返品、環境負荷への効果は測っていない。

成立条件は、環境情報の根拠を商品・素材・表示の版と対応付けられること、第三者認証や対象事業者主張の範囲を区別できること、購入後の長期利用・修理・
...
**効果未確認**: 日用品・雑貨を扱う事業で試す場合は、まず一商品について、環境負荷の主張、根拠、認証・表示、商品ページ・パッケージ、使い方、修理・
詰め替え・回収方法を台帳化する。購入前の表示理解、購入・継続利用、問い合わせ、回収の利用を分けて記録し、環境配慮を訴求しただけの効果と混同しない。
外部資料では現時点でこのpracticeを試す商品事業がないため、効果の主張は置かない。
