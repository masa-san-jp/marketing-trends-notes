...
**未実施**（自分の事業で作品制作、権利管理、プラットフォーム契約、収益分配、著作権異議対応を運用していない）。権利情報の登録率、契約・料率の
...
**未実施。** クリエイターや作品を扱う事業で試す場合は、まず一作品について、権利者、許諾範囲、契約、利用実績、明細、支払、異議・更新を台帳化する。
利用許諾の前後で、権利確認、明細照合、支払、問い合わせ、訂正・異議対応にかかった時間を記録し、権利情報を整備した効果と作品・利用量の増加を混同しない。
自社には現時点でこのpracticeを試すクリエイター事業がないため、効果の主張は置かない。
