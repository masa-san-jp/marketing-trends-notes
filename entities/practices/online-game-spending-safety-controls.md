...
**効果未確認**: 対象事業でオンラインゲームを配信・運営しておらず、年齢確認、保護者承認、支出上限、課金表示、相談・返金対応を一つの運用で測っていない。
...
**効果未確認**: ゲーム事業で試す場合は、一つのタイトルと決済経路に限定し、対象年齢、無料・有料境界、価格、保護者承認、上限、購入履歴、相談・返金先を確認する。
テスト利用者の課金理解、誤購入、相談、返金、利用停止を記録し、未成年者保護上の不明点が残る場合は配信地域や課金機能を広げない。外部資料では現時点でこのpracticeを
